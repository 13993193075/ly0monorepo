...
export default {
    install(app, options) {
        ...
        // 上传组件
        app.component('ly0el-upload', ly0el_upload.Upload);
        app.component('ly0el-upload_avatar', ly0el_upload.Upload_avatar);
        app.component('ly0el-upload_carplate', ly0el_upload.Upload_carplate);
        app.component('ly0el-upload_drag', ly0el_upload.Upload_drag);
        app.component('ly0el-upload_picture', ly0el_upload.Upload_picture);
        app.component('ly0el-upload_pictureCard', ly0el_upload.Upload_pictureCard);
    },
    withTable
}