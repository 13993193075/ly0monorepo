<template>
    ...
    <div :style="style.box(propsItem_box)">
        ...
        <div v-if="propsItem_box.inputType === 'richtext'" :style="style.richtext(propsItem_box)">
            <ly0el-richtext v-model="formData_box[propsItem_box.fieldName]" :myProps="richtextProps"></ly0el-richtext>
        </div>
        <!-- 富文本show -->
...
import ly0elUpload from "../ly0el-upload/Upload.vue"
import ly0elUploadAvator from "../ly0el-upload/Upload-avatar.vue"
import ly0elUploadCarplate from "../ly0el-upload/Upload-carplate.vue"
import ly0elUploadDrag from "../ly0el-upload/Upload-drag.vue"
import ly0elUploadPicture from "../ly0el-upload/Upload-picture.vue"
import ly0elUploadPictureCard from "../ly0el-upload/Upload-picture-card.vue"
