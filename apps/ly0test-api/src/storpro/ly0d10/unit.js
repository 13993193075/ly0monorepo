...
function deleteOne(data) {
    ...
    return new Promise(function (resolve, reject) {
        GQuery({
            ...
            if (result.data) {
                return resolve({code: 1, message: "不能删除，存在关联信息：ly0d10group"})
            }
            GQuery({
                ...
                if (result.data) {
                    return resolve({code: 1, message: "不能删除，存在关联信息：ly0d10worker"})
                }
                GQuery({
                    ...
                    GQuery({
                        ...
                        GQuery({
                            ...
                            GQuery({
                                ...
                                if (result.data) {
                                    return resolve({code: 1, message: "不能删除，存在关联信息：ly0d10memo0"})
                                }
