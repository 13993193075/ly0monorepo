...
async function setRoomStatus (data) {
    ...
    const upd = {
        ...
        status_text: ly0d4.busicode.roomStatus.find(i=>{
    ...
    await GQuery({
        ...
        update: {
            ...
            room_status_text: ly0d4.busicode.roomStatus.find(i=>{
    ...
    try {
        ...
        await GQuery({
            ...
            update: {
                ...
                checkout: null,
                status_code: '1', // 空房
                status_text: ly0d4.busicode.roomStatus.find(i => i.code === '1').text
            }
        });
        ...
        if(objBusiness.status_code !== "1"){
            ...
            await GQuery({
                ...
                update: {
                    status_code: '1',
                    status_text: ly0d4.busicode.businessStatus.find(i=>{return i.code === '1'}).text
                }
            })
            */
        }
                ...
                roomUpdateTasks.push(
                    GQuery({
                        ...
                        update: {
                            ...
                            status_text: iBGoods.room_status_text || ly0d4.busicode.roomStatus.find(i=>{return i.code === '2'}).text
                        }
                    })
                )
            }
