...
async function updateOne ({data, dependencies}) {
    ...
    await dependencies.GQuery.GQuery({
        ...
        update: {
            ...
            f0code: data.f0code || "",
            f0: data.f0code
                ? dependencies.ly0utils.ly0d14.busicode.d7f0.find(i=>{
                    return i.code === data.f0code
                }).text : "",

            f1code: data.f1code || "",
            f1: data.f1code
                ? dependencies.ly0utils.ly0d14.busicode.d7f1.find(i=>{
                    return i.code === data.f1code
                }).text : "",

            f2code: data.f2code || "",
            f2: data.f2code
                ? dependencies.ly0utils.ly0d14.busicode.d7f2.find(i=>{
                    return i.code === data.f2code
                }).text : "",

            f3code: data.f3code || "",
            f3: data.f3code
                ? dependencies.ly0utils.ly0d14.busicode.d7f3.find(i=>{
                    return i.code === data.f3code
                }).text : "",

            f4f0code: data.f4f0code || "",
            f4f0: data.f4f0code
                ? dependencies.ly0utils.ly0d14.busicode.d7f4f0.find(i=>{
                    return i.code === data.f4f0code
                }).text : "",
            f4f1code: data.f4f0code && data.f4f1code ? data.f4f1code : "",
            f4f1: data.f4f0code && data.f4f1code
                ? dependencies.ly0utils.ly0d14.busicode.d7f4f1.find(i=>{
                    return i.code === data.f4f1code
                }).text : "",

            f5code: data.f5code || "",
            f5: data.f5code
                    ? dependencies.ly0utils.ly0d14.busicode.d7f5.find(i=>{
                        return i.code === data.f5code
                    }).text : "",

            f6code: data.f6code || "",
            f6: data.f6code
                ? dependencies.ly0utils.ly0d14.busicode.d7f6.find(i=>{
                    return i.code === data.f6code
                }).text : "",

            f7code: data.f7code || "",
            f7: data.f7code
                ? dependencies.ly0utils.ly0d14.busicode.d7f7.find(i=>{
                    return i.code === data.f7code
                }).text : "",

            f8code: data.f8code || "",
            f8: data.f8code
                ? dependencies.ly0utils.ly0d14.busicode.d7f8.find(i=>{
                    return i.code === data.f8code
                }).text : "",

            f9code: data.f9code || "",
            f9: data.f9code
                ? dependencies.ly0utils.ly0d14.busicode.d7f9.find(i=>{
