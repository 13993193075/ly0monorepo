...
async function updateOne ({data, dependencies}) {
    ...
    await dependencies.GQuery.GQuery({
        ...
        update: {
            ...
            f3: data.f3,
            f3item_code: data.f3item_code || "",
            f3item: data.f3item_code
                ? dependencies.ly0utils.ly0d14.busicode.d10f3item.find(i=>{
                    return i.code === data.f3item_code
                }).text : "",
            f3result_code: data.f3result_code || "",
            f3result: data.f3result_code
                ? dependencies.ly0utils.ly0d14.busicode.d10f3result.find(i=>{
                    return i.code === data.f3result_code
                }).text : "",
            f4: data.f4,
            f5: data.f5,
            f5item_code: data.f5item_code || "",
            f5item: data.f5item_code
                ? dependencies.ly0utils.ly0d14.busicode.d10f5item.find(i=>{
