<template>
  <div style="padding: 10px">
    ...
    ></compFormUpdateOne>
    <compDoc :scopeThis="scopeThis"></compDoc>
  </div>
</template>
  ...
  data: function () {
    return {
      ...
      doc: {
        ...
        fieldsValue: {},
        hdlReload(scopeThis, _id) {
          dataRequest
            .storpro({
              scopeThis,
              storproName: 'ly0d12.room.findOne',
              data: { _id },
            })
            .then((result) => {
              scopeThis.doc.fieldsValue = result.doc
              scopeThis.doc.popup.visible = true
            })
        },
      },
    }
