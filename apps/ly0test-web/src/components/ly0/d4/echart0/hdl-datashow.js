import roomsdays from './hdl-roomsdays.js'
...
function dataShow({scopeThis}) {
    ...
    scopeThis.data.hotel.forEach((itemHotel) => {
        scopeThis.arrDate.forEach((itemDate, indexDate) => {
            let countRoomsDays = roomsdays.roomChannelHotel({
                    id_hotel: itemHotel._id,
                    dataRoom: scopeThis.data.room,
                    dateFrom: itemDate.dateFrom,
                    dateTo: itemDate.dateTo,
                }),
                countRoomsdaysUnknown = roomsdays.roomChannelGoodsUnknown({
                    id_hotel: itemHotel._id,
                ...
                countSale = roomsdays.saleChannelHotel({
                    id_hotel: itemHotel._id,
                ...
                countSaleUnknown0 = roomsdays.saleChannelGoodsUnknown({
                    id_hotel: itemHotel._id,
                    dataGoods: scopeThis.data.goods,
                    dataBusiness: scopeThis.data.business,
                    dataSalebook: scopeThis.data.salebook,
            ...
            countMax = Math.max(countMax, countRoomsDays, countSale)
            ...
            scopeThis.dataShow.push({
                ...
                countMax,
                countRoomsDays,
                countRoomsDays_percent: countMax === 0 ? 0 : Math.floor((countRoomsDays / countMax) * 100),
                countRoomsdaysUnknown,
                countRoomsdaysUnknown_percent: countMax === 0 ? 0 : Math.floor((countRoomsdaysUnknown / countMax) * 100),
                countSale,
                countSale_percent: countMax === 0 ? 0 : Math.floor((countSale / countMax) * 100),
                countSaleUnknown,
                countSaleUnknown_percent: countMax === 0 ? 0 : Math.floor((countSaleUnknown / countMax) * 100),
                countSaleUnknown0,
                countSaleUnknown0_percent: countMax === 0 ? 0 : Math.floor((countSaleUnknown0 / countMax) * 100),
            })

            scopeThis.data.goods.forEach((itemGoods) => {
                let countRoomsDays = roomsdays.roomChannelGoods({
                        id_hotel: itemHotel._id,
                    ...
                    countSale = roomsdays.saleChannelGoods({
                        id_hotel: itemHotel._id,
                        id_goods: itemGoods._id,
                        dataBusiness: scopeThis.data.business,
                        dataSalebook: scopeThis.data.salebook,
                    ...
                    countSaleUnknown = roomsdays.saleChannelGoodsBooktypeUnknown({
                        id_hotel: itemHotel._id,
                        id_goods: itemGoods._id,
                        dataBooktype: scopeThis.data.booktype,
                        dataBusiness: scopeThis.data.business,
                ...
                scopeThis.dataShow.push({
                    ...
                    countRoomsDays_percent:
                        countMax === 0 ? 0 : Math.floor((countRoomsDays / countMax) * 100),
                    countSale,
                    countSale_percent: countMax === 0 ? 0 : Math.floor((countSale / countMax) * 100),
                    countSaleUnknown,
            ...
            scopeThis.data.booktype.forEach((itemBooktype) => {
                let countSaleUnknown = roomsdays.saleChannelGoodsUnknownBooktype({
                    id_hotel: itemHotel._id,
                    id_booktype: itemBooktype._id,
                    dataGoods: scopeThis.data.goods,
                    dataBusiness: scopeThis.data.business,
...
function dataItem(para) {
    ...
    return {
        countMax: 0,
        countRoomsDays: 0,
        countRoomsDays_percent: 0,
        countRoomsdaysUnknown: 0,
        countRoomsdaysUnknown_percent: 0,
        countSale: 0,
        countSale_percent: 0,
        countSaleUnknown: 0,
