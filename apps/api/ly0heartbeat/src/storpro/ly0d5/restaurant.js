...
function dataRule (data) {
    // 不能提交
    if (!data.name) {
        return {code: 1, message: '餐馆名称：必填项'}
    }
...
function deleteOne (data) {
    ...
    return new Promise(function (resolve, reject) {
        GQuery({
            ...
            operator: 'findOne',
            query: {id_restaurant: _id}
        }).then(result => {
            if (result.data) {
                return resolve({
                    code: 1,
                    message: '不能删除，存在关联信息：ly0d5diningplace'
                })
            }
            GQuery({
                ...
                if (result.data) {
                    return resolve({
                        code: 1,
                        message: '不能删除，存在关联信息：ly0d5goodsgroup'
                    })
                }
                GQuery({
                    ...
                    if (result.data) {
                        return resolve({
                            code: 1,
                            message: '不能删除，存在关联信息：ly0d5goods0group'
                        })
                    }
                    GQuery({
                        tblName: 'ly0d5table',
                        ...
                        if (result.data) {
                            return resolve({
                                code: 1,
                                message: '不能删除，存在关联信息：ly0d5table'
                            })
                        }
                        GQuery({
                            tblName: 'ly0d5goods',
                            ...
                            if (result.data) {
                                return resolve({
                                    code: 1,
                                    message: '不能删除，存在关联信息：ly0d5goods'
                                })
                            }
                            GQuery({
                                tblName: 'ly0d5goods0',
                                ...
                                if (result.data) {
                                    return resolve({
                                        code: 1,
                                        message: '不能删除，存在关联信息：ly0d5goods0'
                                    })
                                }
                                GQuery({
                                    tblName: 'ly0d5goods1',
                                    ...
                                    if (result.data) {
                                        return resolve({
                                            code: 1,
                                            message: '不能删除，存在关联信息：ly0d5goods1'
                                        })
                                    }
                                    GQuery({
                                        ...
                                        if (result.data) {
                                            return resolve({
                                                code: 1,
                                                message: '不能删除，存在关联信息：ly0d5business'
                                            })
                                        }
                                        GQuery({
                                            ...
                                            if (result.data) {
                                                return resolve({
                                                    code: 1,
                                                    message: '不能删除，存在关联信息：ly0d5b_table'
                                                })
                                            }
                                            GQuery({
                                                ...
                                                if (result.data) {
                                                    return resolve({
                                                        code: 1,
                                                        message: '不能删除，存在关联信息：ly0d5b_goods'
                                                    })
                                                }
                                                GQuery({
                                                    ...
                                                    GQuery({
                                                        ...
                                                        if (result.data) {
                                                            return resolve({
                                                                code: 1,
                                                                message: '不能删除，存在关联信息：ly0d5b_goods1'
                                                            })
                                                        }
                                                        GQuery({
                                                            tblName: 'ly0d5memo',
